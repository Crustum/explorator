...
/**
 * Feature tests for MakeRangeSearchableJob.
 */
class MakeRangeSearchableTest extends FeatureTestCase
{
    ...
    protected function executeRange(int $start, int $end): ?string
    {
        ...
        return (new MakeRangeSearchableJob())->execute($message);
    }
    ...
    public function testExecuteAcksEmptyRange(): void
    {
        ...
        $this->assertSame(Processor::ACK, (new MakeRangeSearchableJob())->execute($message));
    ...
    public function testHandleWithSingleIdRange(): void
    {
        ...
        $this->assertJobQueuedTimes(MakeSearchableJob::class, 1);
    }
