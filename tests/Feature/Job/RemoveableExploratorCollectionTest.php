...
/**
 * Feature tests for RemoveableExploratorCollection.
 */
class RemoveableExploratorCollectionTest extends TestCase
{
    /**
     * @return void
     */
    public function testFromEntitiesExtractsExploratorKeys(): void
    {
        ...
        $collection = RemoveableExploratorCollection::fromEntities([$entity]);
    ...
    public function testGetQueueableIds(): void
    {
        ...
        $collection = RemoveableExploratorCollection::fromEntities([$one, $two]);
    ...
    public function testGetQueueableIdsResolvesCustomExploratorKeys(): void
    {
        ...
        $collection = RemoveableExploratorCollection::fromEntities($entities);
     ...
     * @return void
     */
    public function testRemoveableExploratorCollectionReturnsExploratorKeys(): void
    {
        ...
        $collection = RemoveableExploratorCollection::fromEntities([
            $chirpOne,
            $chirpTwo,
            $userOne,
            $userTwo,
