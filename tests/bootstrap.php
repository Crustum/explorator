...
use Crustum\Explorator\ExploratorPlugin;
...
Configure::write('FixtureFactories', [
    'testFixtureNamespace' => 'Crustum\\Explorator\\Test\\Factory',
]);

Cache::setConfig('_cake_core_', [
    'className' => 'File',
    'path' => CACHE,
    'prefix' => 'explorator_test_core_',
]);
Cache::setConfig('_cake_translations_', [
    'className' => 'File',
    'path' => CACHE . 'persistent/',
    'prefix' => 'explorator_test_translations_',
    'serialize' => true,
    'duration' => '+10 seconds',
]);
...
Plugin::getCollection()->add(new ExploratorPlugin([
    'path' => dirname(__DIR__) . DS,
]));

Configure::load('Crustum/Explorator.explorator', 'default');
